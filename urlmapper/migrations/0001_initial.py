    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(unique=True, max_length=64, verbose_name='Key', choices=[(b'terms-and-conditions', b'terms-and-conditions'), (b'twigplayer', b'twigplayer'), (b'awards', b'awards')])),
